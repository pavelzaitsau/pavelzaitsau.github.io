...
dotnet; docker; azure; aws; mongo; postgre; sql server; redis; rabbit; elk; jenkins; teamcity; selenium; javascript;

## Experience

2022 – present: **Senior Software Consultant**
...
Stack: AWS, docker, dotnet, postgre, wpf, jenkins
...
Stack: .net framework; devexpress; javascript; sql server; git; azure; jenkins; trello;
